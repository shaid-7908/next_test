...
summary : "The article describes the author's creation of a micro web-app that employs QR codes to store and retrieve messages. Using Python and AWS services, the app generates QR codes for messages, explains QR code mechanics, outlines its architecture and development process, and offers access to the app and its source code for interested readers."
date: "2021-08-14"
---
